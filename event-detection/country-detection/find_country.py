...
tweets = pd.read_csv("../twitter-swisscom/event/event_no_country.csv", sep=',', encoding='utf-8')
tweets['country'] = tweets.apply(in_switzerland, axis=1)
tweets.to_csv("../twitter-swisscom/event/event_country.csv", sep=',', encoding='utf-8', index=False)